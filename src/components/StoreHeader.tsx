...
function CoinsIcon() {
  return (
    <svg viewBox="0 0 512 512" width="14" height="14" aria-hidden>
      <path
        fill="currentColor"
        d="M512 80c0 44.2-85.96 80-192 80S128 124.2 128 80 213.96 0 320 0s192 35.82 192 80z"
      />
    </svg>
  );
}
...
function BikeIcon() {
  return (
    <svg viewBox="0 0 640 512" width="14" height="14" aria-hidden>
      <path
        fill="currentColor"
        d="M512 224c70.7 0 128 57.3 128 128s-57.3 128-128 128-128-57.3-128-128c0-40.9 18.4-75.7 48-99.2L384 224c0 88.4-71.6 160-160 160S64 312.4 64 224 135.6 64 224 64h96c13.3 0 24 10.7 24 24s-10.7 24-24 24h-96c-61.9 0-112 50.1-112 112s50.1 112 112 112 112-50.1 112-112V160h64c13.3 0 24 10.7 24 24v40z"
      />
    </svg>
  );
}
...
function PinIcon() {
  return (
    <svg viewBox="0 0 384 512" width="14" height="14" aria-hidden>
      <path
        fill="currentColor"
        d="M168.3 499.2C116.1 435 0 279.4 0 192 0 85.96 85.96 0 192 0s192 85.96 192 192c0 87.4-116.1 243-167.7 307.2-12.3 15.3-35.1 15.3-47.4 0zM192 256c35.3 0 64-28.7 64-64s-28.7-64-64-64-64 28.7-64 64 28.7 64 64 64z"
      />
    </svg>
  );
}
