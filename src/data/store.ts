...
export const products: Product[] = [
  ...
  },
  {
    ...
    highlight:
      "A maioria dos clientes escolhe esse porque é o melhor custo-benefício!",
    stock: 16,
    image: "/images/combo-gigante.jpg",
    pizzaCount: 2,
    drinkCount: 2,
    borderMax: 2,
  },
  {
    id: "i1",
    slug: "pizza-individual",
    category: "individual",
    title: "Pizza Individual",
    subtitle:
      "Massa artesanal, perfeita para uma pessoa. Escolha o sabor e se apaixone!",
    price: 24.9,
    startingAt: true,
  ...
  },
  {
    ...
    title: "Pizza Doce",
    subtitle:
      "Escolha o sabor. Massa tradicional ou borda recheada com doce de leite.",
    price: 29.5,
    startingAt: true,
